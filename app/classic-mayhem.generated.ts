    ...
    "abilities": [
      {
        ...
        "cost": null,
        "range": null,
        "numericDetail": "技能文本：每当一名在过去3秒被卡特琳娜所伤害的敌方英雄阵亡时，卡特琳娜的技能的冷却时间就会减少15秒。 如果卡特琳娜拾起一把匕首，她会用它来斩击附近的所有敌人来造成按对局实时属性计算魔法伤害。\n补充数值：每当一名在过去3秒被卡特琳娜所伤害的敌方英雄阵亡时，卡特琳娜的技能的冷却时间就会减少15秒。 如果卡特琳娜拾起一把匕首，她会用它来斩击附近的所有敌人来造成按对局实时属性计算魔法伤害。 匕首的斩击会对英雄们施加攻击特效。",
        "numericVersion": "Riot Data Dragon 16.15.1 / CommunityDragon 16.15",
    ...
    "abilities": [
      {
        ...
        "cost": null,
        "range": null,
        "numericDetail": "技能文本：拉克丝的伤害型技能会标记目标6秒。拉克丝的攻击会消耗该标记，以造成按对局实时属性计算魔法伤害。 终极闪光在命中敌人时将先消耗标记然后刷新标记。",
        "numericVersion": "Riot Data Dragon 16.15.1 / CommunityDragon 16.15",
    ...
    "abilities": [
      {
        ...
        "cost": null,
        "range": null,
        "numericDetail": "技能文本：在击杀了一名单位后，崔斯特会投掷他的“幸运”骰，随机获得1到6的额外赏金。\n补充数值：在击杀了一名单位后，崔斯特会投掷他的“幸运”骰，随机获得1到6的额外赏金。 已诈来的金币总和：按对局实时属性计算 已暴击诈来的金币总和：按对局实时属性计算 这个技能可以暴击。",
        "numericVersion": "Riot Data Dragon 16.15.1 / CommunityDragon 16.15",
  ...
  },
  {
    ...
    "abilities": [
      ...
      },
      {
        ...
        "cost": "30/35/40/45/50",
        "range": "400",
        "numericDetail": "技能文本：被动：墨菲特获得10/15/20/25/30%护甲(按对局实时属性计算)。这个效果会在花岗岩护盾激活时提升至30/45/60/75/90% (按对局实时属性计算)。 主动：墨菲特的下次攻击造成额外的30/40/50/60/70 + 0.2 × 法术强度 + 0.15 × 护甲物理伤害 攻击特效，并会引发一阵余震，以在其方向造成15/25/35/45/55 + 0.3 × 法术强度 + 0.15 × 护甲物理伤害 攻击特效。在接下来的5秒内，他的攻击会继续引发余震 攻击特效。\n补充数值：对野怪造成180%伤害。\n等级成长：护甲=10/15/20/25/30%；伤害=30/40/50/60/70；余波溅射伤害=15/25/35/45/55\n基础参数：冷却=10/9.5/9/8.5/8；消耗=30/35/40/45/50；范围=400",
        "numericVersion": "Riot Data Dragon 16.15.1 / CommunityDragon 16.15",
        "sourceUrl": "https://raw.communitydragon.org/16.15/game/data/characters/malphite/malphite.bin.json",
        "dataDragonSourceUrl": "https://ddragon.leagueoflegends.com/cdn/16.15.1/data/zh_CN/champion/Malphite.json",
        "numericStatus": "partial",
    ...
    "abilities": [
      {
        ...
        "cost": null,
        "range": null,
        "numericDetail": "技能文本：基兰将时光储存为经验值并能将其提供给他的友军。当他拥有足够的经验值来使一名友方英雄升级时，他就能通过右键点击来传授经验值。基兰自身也会获得等值的经验值。\n补充数值：基兰将时光储存为经验值并能将其提供给他的友军。当他拥有足够的经验值来使一名友方英雄升级时，他就能通过右键点击来传授经验值。基兰自身也会获得等值的经验值。 总共已奖励：1 × 状态层数经验值。 无法在战斗中传授经验值。",
        "numericVersion": "Riot Data Dragon 16.15.1 / CommunityDragon 16.15",
        ...
        "numericStatus": "partial",
        "unresolvedTokens": [
          "同版本模式本地化词条 Spell_HeightenedLearning_Tooltip_1 未独立公开"
        ]
      },
      {
        "key": "Q",
    ...
    "abilities": [
      {
        ...
        "cost": null,
        "range": null,
        "numericDetail": "技能文本：蕾欧娜的各个技能会标记敌人2.5秒，其他友方英雄在对被标记的敌人造成伤害时，会消耗该印记以造成额外的按对局实时属性计算魔法伤害。",
        "numericVersion": "Riot Data Dragon 16.15.1 / CommunityDragon 16.15",
    ...
    "abilities": [
      {
        ...
        "cost": null,
        "range": null,
        "numericDetail": "技能文本：维迦的技能会在命中敌方英雄时为他提供1层超凡邪力。参与击杀英雄后会提供额外的5层。 每层超凡邪力会为维迦提供1法术强度。\n补充数值：维迦的技能会在命中敌方英雄时为他提供1层超凡邪力。参与击杀英雄后会提供额外的5层。 每层超凡邪力会为维迦提供1法术强度。 维迦的邪力当前为他提供按对局实时属性计算法术强度",
        "numericVersion": "Riot Data Dragon 16.15.1 / CommunityDragon 16.15",
