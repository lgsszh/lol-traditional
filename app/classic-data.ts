...
export const classicRuneGroups: ClassicRuneGroup[] = [
  {
    ...
    runes: [
      ...
      rune("mark-blank", "空白符文", "空", "攻击速度", "+1.1%攻击速度", 1.1, "r_3_3"),
    ],
  },
  {
    id: "seal",
    ...
    runes: [
      ...
      rune("seal-blank", "空白符文", "空", "护甲", "+0.65护甲", 0.65, "y_1_3"),
  ...
  },
  {
    ...
    runes: [
      ...
      rune("glyph-blank", "空白符文", "空", "冷却缩减", "+0.5%冷却缩减", 0.5, "b_1_3"),
  ...
  },
  {
    ...
    runes: [
      ...
      rune("quint-blank-as", "空白符文", "空", "攻击速度", "+3%攻击速度", 3, "bl_3_3"),
      rune("quint-blank-armor", "空白符文", "空", "护甲", "+2.8护甲", 2.8, "bl_1_3"),
      rune("quint-blank-cdr", "空白符文", "空", "冷却缩减", "+1.7%冷却缩减", 1.7, "bl_3_3"),
